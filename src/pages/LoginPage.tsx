  ...
  return (
    <div className="min-h-screen bg-rose-50 flex justify-center items-center p-4">
      <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-lg">
        <h1 className="text-3xl font-bold font-serif text-rose-800 text-center mb-2">Welcome Back!</h1>
        <p className="text-center text-slate-500 mb-8">Login to manage your blog.</p>
